...
import { ArrowLeftIcon, PlayIcon, HeartIcon } from '../components/Icons';
...
export default function ArtistScreen() {
  ...
  if (!artist) return <View style={styles.loading}><Text style={{ color: colors.textSecondary, fontFamily: fontFamily.regular }}>Artist not found</Text></View>;
...
const styles = StyleSheet.create({
  ...
  artistLabel: { fontSize: fontSize.xs, fontFamily: fontFamily.bold, letterSpacing: 1, color: colors.textSecondary, textTransform: 'uppercase' },
  artistName: {
    fontSize: fontSize.hero, fontFamily: fontFamily.bold,
  ...
  followBtn: {
    ...
    borderRadius: borderRadius.full, borderWidth: 1, borderColor: colors.borderMedium,
  },
  followText: { fontSize: fontSize.sm, fontFamily: fontFamily.semibold, color: colors.textPrimary },

  section: { marginBottom: 24, paddingHorizontal: layout.screenPadding },
  sectionTitle: { fontSize: fontSize.lg, fontFamily: fontFamily.bold, color: colors.textPrimary, marginBottom: 12 },
